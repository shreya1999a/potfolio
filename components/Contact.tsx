...
const PhoneIcon = ({ size = 20 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13.1a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.1 6.1l1.27-.95a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
  </svg>
);
...
const contactLinks = [
  ...
  },
  {
    ...
    label: "Phone",
    value: "+1 425-877-7159",
    href: "tel:+14258777159",
    color: "#22d3ee",
  },
  {
  ...
  },
  {
    ...
    label: "GitHub",
    value: "github.com/shreya1999a",
    href: "https://github.com/shreya1999a",
    color: "#8b5cf6",
  },
];
        ...
        <div className="fade-up max-w-xl mx-auto space-y-4">
          {contactLinks.map(({ IconComponent, label, value, href, color }) => (
            <a
              ...
              className="flex items-center gap-5 p-5 rounded-xl border border-[#1e2540] bg-[#0a0b14] hover:border-[#6366f1]/40 hover:bg-[#6366f1]/5 transition-all duration-200 group"
            >
              <div
              ...
              <div>
                <p
                  className="text-xs text-[#8892b0] uppercase tracking-wide mb-0.5"
                  style={{ fontFamily: "var(--font-mono)" }}
                >
                  {label}
                </p>
                <p
                  className="text-sm font-medium text-[#c8cfe8] group-hover:text-white transition-colors"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  {value}
                </p>
